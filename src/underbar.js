(function() {
  ...
  _.each = function(collection, iterator) {
    if (Array.isArray(collection)===true){
      ...
      var keysForCollection=Object.keys(collection);
      for(var i=0; i<keysForCollection.length; i++){
        iterator(collection[keysForCollection[i]], keysForCollection[i], collection);
      }
    }
  };
  ...
  _.extend = function(obj) {
    ...
    for (var i=1; i<arguments.length; i++){
      ...
      for (var j=0; j<keysArray.length; j++){
        obj[keysArray[j]]=arguments[i][keysArray[j]];
      }
    }
    return obj;
    } else {
  ...
  _.memoize = function(func) {
    ...
    return function (){ 
        ...
        var stringOfKeys = arrayOfKeys.join(",");
        if(obj[stringOfKeys]===undefined){
            result = func.apply(this, arguments);
            obj[arrayOfKeys[stringOfKeys]]=result;
            return result;
          } else {
    ...
    //       result = func.apply(this, arguments);
    //       obj[arguments]=result;
    //       return result;
    //     } else {
    //       obj[arguments]=func(arguments);
  ...
  _.delay = function(func, wait) {
    ...
    if(arguments.length>2){
      ...
      for (var i=2; i<arguments.length; i++){
       ...
       setTimeout(func.apply(this, args), wait);// if i don't know the specific number of arguments, how do i provide them?
    }
  };
  ...
  _.shuffle = function(array) {
    ...
    for(var i=0; i<array.length; i++){
      var random = Math.floor(Math.random()*(copyOfArray.length-1-(0))+(0));
      console.log(random);
        finalArray.push(copyOfArray[random]);
        copyOfArray.splice(random,1);
        console.log(random);
    }
    return finalArray;
